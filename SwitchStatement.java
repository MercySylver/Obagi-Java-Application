		...
		switch(code){
			case "*131#":
			{
				...
				switch(option){
					case 1:
					{
						System.out.println("Your 1 month Data Subscription has been activated");
					}
					break;
					
					case 2:
					{
						System.out.println("Your 2 months Data Subscription has been activated");
					}
					break;
					
					case 3:
					{
						System.out.println("Your 3 months Data Subscription has been activated");
					}
					break;
					
					case 4:
					{
						System.out.println("Your 4 months Data Subscription has been activated");
					}
					break;
			...
			case "*606#":
			{
				...
				switch(option){
					case 1:
					{
						System.out.println("Your have borrowed N1000");
					}
					break;
					
					case 2:
					{
						System.out.println("Your have borrowed N2000");
					}
					break;
					
					case 3:
					{
						System.out.println("Your have borrowed N3000");
					}
					break;
					
					case 4:
					{
						System.out.println("Your have borrowed N4000");
					}
					break;
